...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.titulo_version= customtkinter.CTkLabel(self.barralateral, text="Version 1.0.2 \n\n2023", font=customtkinter.CTkFont(size=15, weight="bold"))
    ...
    def generar(self,geometria,ruta,id):
        ...
        if App.verificar(ruta,nombre,id):
            ...
            if geometria==3:
                ...
                self.geometria(0,data,ruta+"/00000000carpetamomentanea","puntos",sis_coor[sistema])
                self.geometria(1,data,ruta+"/00000000carpetamomentanea","linea",sis_coor[sistema])
                ...
                if id==1:
                    ...
                    self.geometria(geometria,data,ruta+"/shape",nombre,sis_coor[sistema])
                    ...
                    if id==2:
                        ...
                        os.makedirs(ruta+"/00000000carpetamomentanea")
                        self.geometria(geometria,data,ruta+"/00000000carpetamomentanea",nombre,sis_coor[sistema])
    ...
    def geometria(self,tip,data,ruta_carpeta,nombre,sis_coor):
